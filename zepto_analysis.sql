...
--Q.1.Find the top 10 best-value prodcuts based on the discount percentage.
...
--Q.4.Find all products where MRP is greater than 500 RS. and discount is less than 10%.
SELECT DISTINCT name, mrp, discountPercent
FROM zepto
...
--Q.6.Find the price per gram for proucts above 100g and sort by best value.
...
--Q.7.Group the products into categroies like Low,Medium,Bulk.
